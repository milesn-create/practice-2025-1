# Отчет по разработке Telegram-бота для напоминаний о днях рождения  [ТГ бот](https://web.telegram.org/k/#@dr_happy_reminder_bot) (работает локально,для запуска у других пользователей необходимо запустить бота в консоли предварительно)
# Содержание
...
8. [Скриншоты рабочего Тг-бота](#8-скриншоты-рабочего-бота:)
